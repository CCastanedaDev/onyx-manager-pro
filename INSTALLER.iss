...
; Adaptado para la versión final compilada
...
; --- CORRECCIÓN CRÍTICA ---
; Forzamos una carpeta SIN ESPACIOS para evitar problemas con SteamCMD.
...
[Files]
; Fuente: Carpeta dist generada por PyInstaller
